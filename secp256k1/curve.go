...
type KoblitzCurve struct {
	*elliptic.CurveParams
	...
	// cofactor of the curve, H = N/n
	// N is the order of group of ECC, n is the order of the cyclic subgroup
	H         int
...
func initS256() {
	...
	// In secp256k1, the order of prime field is larger than the ecc order(number of point
	// on curve).
